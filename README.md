...
**Job Application**
- Application metadata (S3 file key, job ID, user info) is submitted to the backend. Lambda is invoked in event mode to generate AI score while the rest of the data is pushed to the DB.
